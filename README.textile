...
bq. #{input for:'user.name', id:'YourID', class:'class1 class2', value:field.value /}

The tag will then output the following HTML code:

bq. <input name="user.name" value="${user.name}" id="YourID" class="class1 class2" required maxlength="8"> 
